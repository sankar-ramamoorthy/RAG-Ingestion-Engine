...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table_schema="ingestion_service",  # <-- default schema
    )
...
def run_migrations_online() -> None:
    ...
    with connectable.begin() as connection:
        ...
        context.configure(
            ...
            target_metadata=target_metadata,
            version_table_schema="ingestion_service",  # <-- default schema
            # Add this to ensure Alembic sees your schema-qualified tables
            include_schemas=True,
        )
        # Alembic will join the existing transaction from connectable.begin()
        context.run_migrations()
